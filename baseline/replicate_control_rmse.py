"""
Replicate-level RMSE for control clinical pathology data.
...
4. Within each (COMPOUND_NAME, SACRIFICE_PERIOD) group:
   ...
   - Compute RMSE between all replicate pairs.
5. Write out one row per unique replicate pair with:
   COMPOUND_NAME, SACRIFICE_PERIOD, INDIVIDUAL_ID_1, INDIVIDUAL_ID_2, rmse.
...
all38_csv = join(POS_CTRL_BASE_PATH, "pc_rmse_overall.csv")
