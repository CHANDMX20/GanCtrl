"""
Real vs Synthetic Control RMSE (Train Controls, High Dose Only)
==============================================================

Purpose
-------
This script compares *real* train control profiles to *synthetic* control-like
...
----------------
1. Load:
   - real_control: per-animal clinical pathology data for train controls
   - syn_control:  generated predictions for the corresponding train animals
...
# -----------------------------
# Real train controls (per-animal clinical pathology for control dose)
