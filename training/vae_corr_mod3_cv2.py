...
def define_composite_cvae_gan(e_model, g_model, d_model,
    ...
    # ---- variance monitoring tensors (Python floats in closures ? H5-safe) ----
    ...
    # Log the variance monitoring tensors as metrics
    ...
    # ==============================
    # Batch mean-matching add_loss (gentle): E[x_hat] - E[x_real_control]
    # ==============================
...
def save_models(step, g_model, d_model, c_model,
                resultPath='/account001/mansi.chandra/clin_path/results_vae_corr_mod3_cv2'):
